                ...
                <div className="bg-slate-100/10 flex flex-col gap-4 py-6 px-4 md:p-8 rounded-md md:rounded-lg">
                    <div className='flex flex-col text-left gap-2 md:gap-4'>
                        ...
                        <div className='flex w-full gap-2 items-center'>
                            <div className='flex items-center grow border-b border-dashed border-gray-300 focus-within:border-primary-light px-2'>
                                <span className="text-sm text-gray-600">USD</span>
                                <input type="text" className='text-gray-700 py-0 px-0 border-0 grow text-lg outline-0 bg-transparent text-right' />
                        ...
                        <div className="flex flex-col mt-3 w-full">
                            <p className='text-gray-500 text-right text-xs'>Return on Investtment</p>
