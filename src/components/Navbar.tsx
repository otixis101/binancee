        ...
        <nav className="flex justify-between items-center md:px-4 bg-white">
            ...
            <ul className="flex justify-end pr-2 md:pr-0 gap-4 md:gap-8 md:justify-end text-sm w-full items-center">
                ...
                <li className="flex flex-col relative h-full md:hidden">
                    ...
                    {isOpen && (
                        <ul className="flex flex-col gap-3 fixed z-20 text-lg inset-0 p-4 grow bg-white text-center">
                            <li className="flex justify-end mb-12">
                                <button onClick={toggleDropdown}><XMarkIcon className="w-8 h-8" /></button>
                            </li>
                            <li className="hover:text-primary-dark py-2"><Link href={"/dashboard"}> Dashboard</Link></li>
                            <li className="hover:text-primary-dark py-2"><Link href={"/security"}> Security</Link></li>
                            <li className="hover:text-primary-dark py-2"><Link href={"/identification"}>Identification</Link></li>
                            <li className="hover:text-primary-dark py-2"><Link href={"/deposit"}>Deposit</Link></li>
                            <li className="hover:text-primary-dark py-2"><Link href={"/withdrawal"}>Withdrawal</Link></li>
                            <li className="hover:text-primary-dark py-2"><Link href={"/wallet"}>Wallet</Link></li>
                        </ul>
                    )}
                </li>
            </ul>
