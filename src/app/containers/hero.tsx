            ...
            <ul className="flex flex-col md:flex-col-reverse lg:flex-row justify-between items-center">
                <li className="flex flex-col gap-10 grow basis-[52%]">
                    ...
                    <div className='flex flex-col gap-4 w-full lg:w-[80%]'>
                        <Link href={'/register'} className="flex items-center justify-center gap-4 bg-primary-light p-4 font-semibold rounded-md"><UserIcon className="w-6 h-6" /> Sign up with Email or Phone</Link>
                        ...
                        <Link href={'/register'} className="flex justify-center gap-4 bg-gray-200 p-4 font-semibold rounded-md"> <Image src={googleImage} alt="hero_image" className='w-6 h-6' />  Google</Link>
